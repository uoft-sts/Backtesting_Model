...
class Portfolio:
    def __init__(self, portfolio_returns, debt = None, equity = None, init_investment=1):
    ...
    def compute_cumulative_return(self):
        ...
        """
        cumulative_return = self.returns.sum()
    ...
    def summarize_performance(self, market_return, required_return):
        metrics = dict()
        metrics["Cumulative_Return"] = self.compute_cumulative_return()
